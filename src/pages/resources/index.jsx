    ...
    return (
        <div className="grid-resources-container">
            ...
            <div className="grid-resources-expansion-panels-1">
                ...
                <ExpansionPanel expanded={expanded === 'panel3'} onChange={handleExpand('panel3')}>
                    ...
                    <ExpansionPanelDetails>
                        <div>
                            ...
                            <div>
                                <ExpansionPanel expanded={subExpanded === 'sub-panel1'} onChange={handleSubExpand('sub-panel1')}>
                                    <ExpansionPanelSummary
                                        expandIcon={<ExpandMoreIcon />}
                                        aria-controls="panel1a-content"
                                        id="panel1a-header"
                                ...
                                <ExpansionPanel expanded={subExpanded === 'sub-panel2'} onChange={handleSubExpand('sub-panel2')}>
                                    <ExpansionPanelSummary
                                        expandIcon={<ExpandMoreIcon />}
                                        aria-controls="panel1a-content"
                                        id="panel1a-header"
                                ...
                                <ExpansionPanel expanded={subExpanded === 'sub-panel3'} onChange={handleSubExpand('sub-panel3')}>
                                    <ExpansionPanelSummary
                                        expandIcon={<ExpandMoreIcon />}
                                        aria-controls="panel1a-content"
                                        id="panel1a-header"
                ...
                <ExpansionPanel expanded={expanded === 'panel5'} onChange={handleExpand('panel5')}>
                    <ExpansionPanelSummary
                        expandIcon={<ExpandMoreIcon />}
                        aria-controls="panel1a-content"
                        id="panel1a-header"
                ...
                <ExpansionPanel expanded={expanded === 'panel6'} onChange={handleExpand('panel6')}>
                    <ExpansionPanelSummary
                        expandIcon={<ExpandMoreIcon />}
                        aria-controls="panel1a-content"
                        id="panel1a-header"
                ...
                <ExpansionPanel expanded={expanded === 'panel7'} onChange={handleExpand('panel7')}>
                    <ExpansionPanelSummary
                        expandIcon={<ExpandMoreIcon />}
                        aria-controls="panel1a-content"
                        id="panel1a-header"
                ...
                <ExpansionPanel expanded={expanded === 'panel8'} onChange={handleExpand('panel8')}>
                    <ExpansionPanelSummary
                        expandIcon={<ExpandMoreIcon />}
                        aria-controls="panel1a-content"
                        id="panel1a-header"
                ...
                <ExpansionPanel expanded={expanded === 'panel9'} onChange={handleExpand('panel9')}>
                    <ExpansionPanelSummary
                        expandIcon={<ExpandMoreIcon />}
                        aria-controls="panel1a-content"
                        id="panel1a-header"
                ...
                <ExpansionPanel expanded={expanded === 'panel10'} onChange={handleExpand('panel10')}>
                    <ExpansionPanelSummary
                        expandIcon={<ExpandMoreIcon />}
                        aria-controls="panel1a-content"
                        id="panel1a-header"
